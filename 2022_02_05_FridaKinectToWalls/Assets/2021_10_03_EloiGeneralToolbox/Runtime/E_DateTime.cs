...
public class E_DateTime 
{
        ...
        public static void GetFileFormatOfNow(out string fileFormatNoExtension)
        {
            GetFileFormat(DateTime.Now, out fileFormatNoExtension);
        }
        public static void GetFileFormat(in DateTime time, out string fileFormatNoExtension)
        {
            fileFormatNoExtension = time.ToString("yyyyMMddHHmmss");
        }
